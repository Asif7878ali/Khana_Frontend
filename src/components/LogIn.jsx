          ...
          <div className="w-full rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 bg-white">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" action="" onSubmit={handleSubmit}>
                       ...
                       {/* Name */}
                <div>
                  <label htmlFor="email" className="block mb-2 text-sm font-medium text-black">Your E-mail</label>
                  <input type="email" name="email" id="email" autoComplete=""
                    ...
                    placeholder="name@gmail.com" required value={values.email} onBlur={handleBlur} onChange={handleChange}/>
                ...
                <div>
                  <label htmlFor="password" className="block mb-2 text-sm font-medium text-black">Password</label>
                    ...
                    <input type={showPassword ? 'text' : 'password'} name="password" id="password" placeholder="••••••••" autoComplete="" value={values.password} onBlur={handleBlur} onChange={handleChange}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <p className="text-sm font-medium text-blue-600 hover:underline cursor-pointer">Forgot password?</p>
                  </Link>
                </div>
                ...
                <p className="text-sm  text-black">Don’t have an account yet?
                <Link to='/'>  
                <span className="font-medium text-primary-600 hover:underline text-black cursor-pointer">SignIn</span> 
                </Link>
