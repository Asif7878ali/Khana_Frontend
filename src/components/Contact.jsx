...
const Contact = () => {
  ...
  const emptyValues = {
   ...
   const regSchema = Yup.object({
    ...
    email  : Yup.string().email('Enter a Valid E-mail').required('E-mail is Required').test('is-gmail', 'Email must be @gmail.com', value =>{
       if(value){
         return value.endsWith('@gmail.com')
       }
       return false
    }),
    number : Yup.string().test('is-ten-digits','Phone number must be 10 digits', value =>{
  ...
  return (
   ...
   { isLogin ? (
         ...
         <div className="w-full bg-slate-200 p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
           <div className="flex">
             <h1 className="font-bold uppercase text-5xl">Contact us a <br /> message</h1>
           </div>
           ...
           <input
               ...
               value={values.number} onBlur={handleBlur} onChange={handleChange}/>
           ...
           <button type='submit' className="uppercase text-sm font-bold tracking-wide bg-blue-900 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">Send Message</button>
